          ...
          <ul className="mt-8 grid grid-cols-1 gap-6 divide-y divide-zinc-200 md:grid-cols-2 lg:grid-cols-3">
            {files
              ...
              .map((file) => (
                ...
                >
                  <Link href={`/dashboard/${file.id}`} className="fcursor-pointer">
                    <div className="pt-6 px-6 flex flex-row gap-2  w-full items-center justify-between space-x-6">
                      ...
                      <div className="flex-1 truncate">
                        <div className="flex items-center space-x-3">
                          <h3 className="truncate text-base font-medium text-zinc-900">{file.name}</h3>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="px-6 mt-4 py-2">
                    <div className="flex justify-between">
                      <p className="text-sm text-zinc-500">Pages: {file.pagesAmt || 'N/A'}</p>
                      <p className="text-sm text-zinc-500">Status: {file.uploadStatus}</p>
                    </div>
                  </div>
